...
{ mdnsSdServer }    = rekuire 'mdns/mdnsSdServer'
...
module.exports.createAdvertisement = createAdvertisement.createAdvertisement

module.exports.mdnsSdServer = mdnsSdServer

module.exports.tcp = MDNSHelper.protocolHelperTcp
module.exports.udp = MDNSHelper.protocolHelperUdp
